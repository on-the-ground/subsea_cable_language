...
- External implementation ADRs: [subsea_cable_vessel `0003-structure-valued-lookup-maps.md`](https://github.com/on-the-ground/subsea_cable_vessel/blob/main/docs/decisions/0003-structure-valued-lookup-maps.md)
