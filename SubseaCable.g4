 ...
 *   outcomes belong to the policy's resolved addressee: the Scheduler by
 *   default, or the Host for a policy its capability declares and that
 *   configures one grounded leaf invocation. A failed deduction commits no partial result
