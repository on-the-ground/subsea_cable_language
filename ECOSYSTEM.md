...
| Language pin | a git submodule carrying the grammar, conformance corpus, `README.md` semantics, and the design documents below; the runtime README records the exact revision, which includes SCP-0001 through SCP-0003 |
