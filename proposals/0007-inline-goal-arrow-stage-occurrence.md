...
- External implementation ADRs: [subsea_cable_vessel `0002-inline-goal-arrow-stages.md`](https://github.com/on-the-ground/subsea_cable_vessel/blob/main/docs/decisions/0002-inline-goal-arrow-stages.md)
